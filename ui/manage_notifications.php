...
<table>	
	<tr>
		<form action="../actions/notification_add" method="POST">
    		...
    		<td class="no-border"><input name="message" type="text" size="30" placeholder="<?php echo $string['manage']['message']; ?>" required/></td>
	...
	<?php
		...
		while($row = mysqli_fetch_array($result)) {
			...
			echo '<td><input type="text" name="message" placeholder="' . $string['manage']['message'] . '" value="' . $row['message'] . '" required/></td>';
