<?php
    $string = [
        ...
        , "checkout" => [
            ...
            , "onlinePayment" => "Онлајн"
            , "cashPayment" => "Поузећем"
		...
		, "propose" => [
            ...
            , "text" => "Предлoжи свој дизајн и шаљемо ти такве чарапе бесплатно ако се другима свиђа идеја"
            , "name" => "Име"
		...
		, "status" => [
			...
			, "alreadyCommented" => "Већ си бацио коментар на овај пар и врло смо ти захвани због тога"
			, "replyNotAdded" => "Одговор није додат" 
			, "replyAdded" => "Одговор је додат" 
