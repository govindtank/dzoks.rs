<?php
    $string = [
		...
		, "status" => [
			...
			, "notificationNotAdded" => "Обавештење није убачено"
			, "notificationAdded" => "Обавештење убачено"
			, "notificationNotUpdated" => "Обавештење није ажурирано"
			, "notificationUpdated" => "Обавештење ажурирано"
			, "notificationNotRemoved" => "Обавештење није уклоњено"
			, "notificationRemoved" => "Обавештење уклоњено"
