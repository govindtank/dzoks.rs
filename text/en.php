<?php
    $string = [
		...
		, "manage" => [
    		...
    		, "totalQuantityBySize" => "Total quantity by size"
			, "warehouse" => "Warehouse"
    		, "contacts" => "Contacts"
            , "send" => "Send"
    		, "comments" => "Comments"
		...
		, "status" => [
			...
			, "notificationNotAdded" => "Notification has not been added"
			, "notificationAdded" => "Notification has been added"
			, "notificationNotUpdated" => "Notification has not been updated"
			, "notificationUpdated" => "Notification has been updated"
			, "notificationNotRemoved" => "Notification has not been removed"
			, "notificationRemoved" => "Notification has been removed"
